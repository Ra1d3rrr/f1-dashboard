    ...
    with tab1:
        ...
        if session:
            ...
            if laps.empty:
                ...
                if 'DriverNumber' in laps.columns and 'BroadcastName' in laps.columns:
                ...
                try:
                    ...
                    if fastest_laps is not None and not fastest_laps.empty:
                        ...
                        if hasattr(fastest_laps, 'columns') and "Compound" in fastest_laps.columns:
                        ...
                        # Clean up driver names for fastest laps too
                        if hasattr(fastest_laps, 'columns') and 'BroadcastName' in fastest_laps.columns:
                            display_fastest['Driver'] = fastest_laps['BroadcastName'].loc[display_fastest.index]
                        elif hasattr(fastest_laps, 'columns') and 'LastName' in fastest_laps.columns:
                            display_fastest['Driver'] = fastest_laps['LastName'].loc[display_fastest.index]
                    ...
                    st.warning("Could not load fastest lap data.")
        ...
        if qualifying_session:
            ...
            if quali_laps.empty:
                ...
                try:
                    ...
                    if fastest_quali_laps is not None and not fastest_quali_laps.empty:
                        # Check available columns and select appropriate ones
                        available_cols = ["Driver", "LapTime"]
                        if hasattr(fastest_quali_laps, 'columns') and "Compound" in fastest_quali_laps.columns:
                            available_cols.append("Compound")
                        ...
                        # Clean up driver names for fastest laps too
                        if hasattr(fastest_quali_laps, 'columns') and 'BroadcastName' in fastest_quali_laps.columns:
                            display_fastest_quali['Driver'] = fastest_quali_laps['BroadcastName'].loc[display_fastest_quali.index]
                        elif hasattr(fastest_quali_laps, 'columns') and 'LastName' in fastest_quali_laps.columns:
                            display_fastest_quali['Driver'] = fastest_quali_laps['LastName'].loc[display_fastest_quali.index]
                        ...
                        st.info("No fastest qualifying lap data available.")
                except Exception as e:
                    st.warning("Could not load fastest qualifying lap data.")
            ...
            if sprint_session:
                ...
                if sprint_laps.empty:
                    ...
                    try:
                        ...
                        if fastest_sprint_laps is not None and not fastest_sprint_laps.empty:
                            # Check available columns and select appropriate ones
                            available_cols = ["Driver", "LapTime"]
                            if hasattr(fastest_sprint_laps, 'columns') and "Compound" in fastest_sprint_laps.columns:
                                available_cols.append("Compound")
                            ...
                            # Clean up driver names for fastest laps too
                            if hasattr(fastest_sprint_laps, 'columns') and 'BroadcastName' in fastest_sprint_laps.columns:
                                display_fastest_sprint['Driver'] = fastest_sprint_laps['BroadcastName'].loc[display_fastest_sprint.index]
                            elif hasattr(fastest_sprint_laps, 'columns') and 'LastName' in fastest_sprint_laps.columns:
                                display_fastest_sprint['Driver'] = fastest_sprint_laps['LastName'].loc[display_fastest_sprint.index]
                            ...
                            st.info("No fastest sprint race lap data available.")
                    except Exception as e:
                        st.warning("Could not load fastest sprint race lap data.")
            ...
            if sprint_qualifying_session:
                ...
                if sprint_quali_laps.empty:
                    ...
                    try:
                        ...
                        if fastest_sprint_quali_laps is not None and not fastest_sprint_quali_laps.empty:
                            # Check available columns and select appropriate ones
                            available_cols = ["Driver", "LapTime"]
                            if hasattr(fastest_sprint_quali_laps, 'columns') and "Compound" in fastest_sprint_quali_laps.columns:
                                available_cols.append("Compound")
                            ...
                            # Clean up driver names for fastest laps too
                            if hasattr(fastest_sprint_quali_laps, 'columns') and 'BroadcastName' in fastest_sprint_quali_laps.columns:
                                display_fastest_sprint_quali['Driver'] = fastest_sprint_quali_laps['BroadcastName'].loc[display_fastest_sprint_quali.index]
                            elif hasattr(fastest_sprint_quali_laps, 'columns') and 'LastName' in fastest_sprint_quali_laps.columns:
                                display_fastest_sprint_quali['Driver'] = fastest_sprint_quali_laps['LastName'].loc[display_fastest_sprint_quali.index]
                            ...
                            st.info("No fastest sprint qualifying lap data available.")
                    except Exception as e:
                        st.warning("Could not load fastest sprint qualifying lap data.")
