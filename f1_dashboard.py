...
# Sidebar navigation
page = st.sidebar.selectbox("Select Page", ["Lap Times (Live)", "Race Results", "Driver Standings", "Constructor Standings", "Event Schedule"])
    ...
    with tab1:
        ...
        if session:
            ...
            if laps.empty:
                ...
                base_cols = ["Driver", "LapNumber", "LapTime", "Compound", "TyreLife"]
                ...
                final_cols = ["Driver", "LapNumber", "LapTime"]
                    ...
                    for i, (tab, session_name) in enumerate([(q_tab1, 'Q1'), (q_tab2, 'Q2'), (q_tab3, 'Q3')], 1):
                        with tab:
                            ...
                            if session_laps.empty:
                                ...
                                display_session_laps = display_session_laps.sort_values(by=["LapNumber", "LapTime"])
        ...
        with tab3:
            ...
            if sprint_session:
                ...
                if sprint_laps.empty:
                    ...
                    display_sprint_laps = sprint_laps[["Driver", "LapNumber", "LapTime", "Compound", "TyreLife"]].copy()
                    ...
                    display_sprint_laps = display_sprint_laps[["Driver", "LapNumber", "LapTime", "Compound", "TyreLife"]]
