...
def load_session(year, rnd, session_type='R'):
    try:
...
# Load all possible sessions
session = load_session(year, round_number, 'R')  # Race
qualifying_session = load_session(year, round_number, 'Q')  # Qualifying
sprint_session = load_session(year, round_number, 'S')  # Sprint Race
sprint_qualifying_session = load_session(year, round_number, 'SQ')  # Sprint Qualifying
...
if page == "Lap Times (Live)":
    ...
    with tab1:
        ...
        if session:
            ...
            if laps.empty:
                ...
                display_fastest = fastest_laps[["Driver", "LapTime", "Compound"]].copy().sort_values(by="LapTime")
    ...
    with tab2:
        ...
        if qualifying_session:
            quali_laps = qualifying_session.laps
            ...
            if quali_laps.empty:
                ...
                # Sort by actual lap time first (before formatting)
                display_fastest_quali = fastest_quali_laps[["Driver", "LapTime", "Compound"]].copy().sort_values(by="LapTime")
                # Then format the lap times
                ...
                display_fastest_quali = display_fastest_quali[["Driver", "LapTime", "Compound"]]
    ...
    if is_sprint_weekend:
        with tab3:
            ...
            if sprint_session:
                ...
                if sprint_laps.empty:
                    ...
                    # Sort by actual lap time first (before formatting)
                    display_fastest_sprint = fastest_sprint_laps[["Driver", "LapTime", "Compound"]].copy().sort_values(by="LapTime")
                    # Then format the lap times
                    ...
                    display_fastest_sprint = display_fastest_sprint[["Driver", "LapTime", "Compound"]]
        ...
        with tab4:
            ...
            if sprint_qualifying_session:
                sprint_quali_laps = sprint_qualifying_session.laps
                ...
                if sprint_quali_laps.empty:
                    ...
                    # Sort by actual lap time first (before formatting)
                    display_fastest_sprint_quali = fastest_sprint_quali_laps[["Driver", "LapTime", "Compound"]].copy().sort_values(by="LapTime")
                    # Then format the lap times
                    ...
                    display_fastest_sprint_quali = display_fastest_sprint_quali[["Driver", "LapTime", "Compound"]]
